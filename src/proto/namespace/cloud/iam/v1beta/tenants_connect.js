...
export const TenantService = {
  typeName: "namespace.cloud.iam.v1beta.TenantService",
  methods: {
    /**
    ...
    describePolicies: {
      ...
      I: DescribePoliciesRequest,
      O: DescribePoliciesResponse,
      kind: MethodKind.Unary,
    },
    /**
     * Updates policies attached to a Tenant.
    ...
    ensureTenantForExternalAccount: {
      ...
      I: EnsureTenantForExternalAccountRequest,
      O: TenantResponse,
      kind: MethodKind.Unary,
    },
    /**
    ...
    issueTenantToken: {
      ...
      I: IssueTenantTokenRequest,
      O: IssueTenantTokenResponse,
      kind: MethodKind.Unary,
    },
    /**
    ...
    issueTenantClientCertificate: {
      ...
      I: IssueTenantClientCertificateRequest,
      O: IssueTenantClientCertificateResponse,
      kind: MethodKind.Unary,
    },
    /**
    ...
    ensureTenantGroup: {
      ...
      I: EnsureTenantGroupRequest,
      O: TenantGroupResponse,
      kind: MethodKind.Unary,
    },
    /**
    ...
    listTenantGroups: {
      ...
      I: ListTenantGroupsRequest,
      O: ListTenantGroupsResponse,
      kind: MethodKind.Unary,
    },
    /**
     * Lists all Tenant Groups owned by the Namespace Partner Account.
    ...
    describeTenantGroup: {
      ...
      I: TenantGroupReference,
      O: DescribeTenantGroupResponse,
      kind: MethodKind.Unary,
    },
  }
};

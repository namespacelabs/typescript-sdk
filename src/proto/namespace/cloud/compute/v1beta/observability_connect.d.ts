 ...
 */
export declare const ObservabilityService: {
  readonly typeName: "namespace.cloud.compute.v1beta.ObservabilityService",
  readonly methods: {
    /**
     ...
     */
    readonly fetchInstanceLogs: {
      readonly name: "FetchInstanceLogs",
      readonly I: typeof FetchInstanceLogsRequest,
      readonly O: typeof FetchInstanceLogsResponse,
